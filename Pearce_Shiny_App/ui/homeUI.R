homeUI <- tabPanel("Home",
                   ...
                   p("Get started with the tool by clicking on the ",em("Data")," tab in the toolbar above, which allows you to get started using either your own data or a built-in toy dataset."),
                   ...
                   tags$ul(
                     ...
                     tags$li('Gallo, Stephen A., et al. "A new approach to peer review assessments: Score, then rank." (2022).')
                   ),
                   h2("Feedback"),
